def up(cursor, bot):
    ...
    cursor.execute(
        """
    CREATE TYPE dotabet_outcome AS ENUM('win', 'loss');
    """
    )

    cursor.execute(
        """
    CREATE TABLE dotabet_game (
        id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        internal_id TIMESTAMPTZ NOT NULL,
        outcome dotabet_outcome NOT NULL,
        points_change INT NOT NULL,
        win_betters INT NOT NULL,
        loss_betters INT NOT NULL
    )
    """
    )
    ...
    cursor.execute("CREATE INDEX ON dotabet_bet(user_id)")
    ...
    cursor.execute(
        """
    CREATE TABLE longtimeout (
        username TEXT PRIMARY KEY NOT NULL,
        timeout_start TIMESTAMPTZ NOT NULL,
        timeout_recent_end TIMESTAMPTZ DEFAULT NULL,
        timeout_end TIMESTAMPTZ NOT NULL,
        timeout_author TEXT NOT NULL
    )
    """
    )
